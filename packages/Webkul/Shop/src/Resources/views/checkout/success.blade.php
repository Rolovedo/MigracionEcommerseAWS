	...
	<div class="container mt-8 px-[60px] max-lg:px-8">
		<div class="grid place-items-center gap-y-5 max-md:gap-y-2.5">
			...
			<a href="{{ route('shop.home.index') }}">
				<div class="m-auto mx-auto block w-max cursor-pointer rounded-2xl bg-brown px-11 py-3 text-center text-base font-medium text-white max-md:rounded-lg max-md:px-6 max-md:py-1.5">
