    ...
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        ...
        @if (core()->getConfigData('customer.settings.newsletter.subscription'))
            <div class="grid gap-2.5">
                <p
                    class="max-w-[288px] text-3xl italic leading-[45px] text-brown max-md:text-2xl max-sm:text-lg"
                    role="heading"
                    aria-level="2"
                >
                ...
                <div>
                    ...
                    >
                        <div class="relative w-full">
                            ...
                            <button
                                type="submit"
                                class="absolute top-1.5 flex w-max items-center rounded-xl bg-lightOrange px-7 py-2.5 font-medium hover:bg-brown-100 max-md:top-1 max-md:px-5 max-md:text-xs max-sm:mt-0 max-sm:rounded-lg max-sm:px-4 max-sm:py-2 ltr:right-2 rtl:left-2"
                            >
