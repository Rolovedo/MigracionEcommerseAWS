            ...
            <div class="relative">
                ...
                >
                    ...
                    >
                        <a
                            :href="category.slug"
                            class="h-[110px] w-[110px] rounded-full bg-brown-100 max-md:h-20 max-md:w-20 max-sm:h-[60px] max-sm:w-[60px]"
                ...
                <span
                    class="icon-arrow-left-stylish absolute -left-10 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-black bg-lightOrange text-2xl transition hover:bg-brown hover:text-white max-lg:-left-7 max-md:hidden"
                    role="button"
                ...
                <span
                    class="icon-arrow-right-stylish absolute -right-6 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-black bg-lightOrange text-2xl transition hover:bg-brown hover:text-white max-lg:-right-7 max-md:hidden"
                    role="button"
