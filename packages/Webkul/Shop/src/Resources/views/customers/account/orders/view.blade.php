<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
            ...
            <div class="flex gap-1.5">
                ...
                @if (
                    ...
                    <a
                        ...
                        class="secondary-button border-brown-200 px-5 py-3 font-normal max-md:hidden"
                    >
        ...
        <div class="mt-8 max-md:mt-5 max-md:grid max-md:gap-4">
                            ...
                            <table class="w-full text-left">
                                ...
                                <tbody>
                                    @foreach ($order->items as $item)
                                        <tr class="border-b bg-lightOrange align-top font-medium [&>*]:px-6 [&>*]:py-4">
                    ...
                    <div class="grid gap-4 md:hidden">
                        ...
                        >
                            ...
                            <x-slot:content class="grid gap-2.5 !bg-gray-100 !p-0">
                                @foreach ($order->items as $item)
                                    <div class="rounded-md rounded-t-none border border-t-0 bg-lightOrange px-4 py-2">
                        ...
                        <div class="w-full rounded-md bg-gray-100">
                            ...
                            <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-lightOrange px-4 py-3 text-xs font-medium">
                            ...
                            <div class="max-md:hidden">
                                ...
                                <div class="relative mt-8 overflow-x-auto rounded-xl border">
                                    <table class="w-full text-left">
                                        ...
                                        <tbody>
                                            @foreach ($invoice->items as $item)
                                                <tr class="border-b bg-lightOrange text-black [&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                    ...
                                    <table class="w-full text-left text-sm">
                                        ...
                                        <tbody>
                                            @foreach ($shipment->items as $item)
                                                <tr class="border-b bg-lightOrange [&>*]:font-medium [&>*]:px-6 [&>*]:py-4 [&>*]:text-black">
            ...
            <!-- Desktop View -->
            <div class="mt-11 flex flex-wrap justify-between gap-x-11 gap-y-8 border-t border-brown-200 pt-7 max-md:hidden">
                <!-- Billing Address -->
                @if ($order->billing_address)
