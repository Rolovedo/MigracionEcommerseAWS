                    ...
                    @if (! $reviews->isEmpty())
                        ...
                        <div class="mt-14 grid gap-5 max-1060:grid-cols-[1fr] max-md:mt-5">
                            @foreach($reviews as $review)
                                ...
                                >
                                    <!-- For Desktop View -->
                                    <div class="flex gap-5 rounded-xl border border-brown-200 p-6 max-md:hidden max-md:gap-1.5">
                                    ...
                                    <!-- For Mobile View -->
                                    <div class="flex gap-5 rounded-xl border border-brown-200 p-6 max-md:grid max-md:gap-2.5 max-md:p-4 md:hidden">
