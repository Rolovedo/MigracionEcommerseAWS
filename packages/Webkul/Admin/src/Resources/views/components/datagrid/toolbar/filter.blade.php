                ...
                >
                    <x-slot:toggle>
                        <div>
                            ...
                            <div class="z-10 hidden w-full divide-y divide-gray-100 rounded bg-white shadow dark:border-zinc-800 dark:bg-zinc-900">
                            </div>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:header>
                        ...
                        <div v-else class="flex items-center gap-x-2">
                            <span
                                class="icon-arrow-right rtl:icon-arrow-left mt-0.5 cursor-pointer text-3xl hover:rounded-md hover:bg-gray-100 dark:hover:bg-zinc-950"
                                @click="backToFilters"
                            >
                            </span>
                                ...
                                <x-slot:content class="border-b !p-0 dark:border-gray-800">
                                    <div class="grid !p-0">
                                        ...
                                        <div v-for="(filter,index) in savedFilters.available">
                                            <div
                                                class="flex cursor-pointer items-center justify-between px-4 py-1.5 text-gray-700 hover:bg-gray-50 dark:text-white dark:hover:bg-zinc-950"
                                                :class="{ 'bg-gray-50 dark:bg-zinc-950 font-semibold': applied.savedFilterId == filter.id }"
                                            ...
                                            <div v-else>
                                                ...
                                                <template v-else>
                                                    ...
                                                    <div class="mb-2 mt-1.5 grid">
                                                        <input
                                                            type="text"
                                                            class="block w-full rounded-md border bg-white px-2 py-1.5 text-sm leading-6 text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-zinc-800 dark:bg-zinc-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400"
                                                            :name="column.index"
                                                            :placeholder="column.label"
                                                            @change="addFilter($event, column)"
                                                        />
