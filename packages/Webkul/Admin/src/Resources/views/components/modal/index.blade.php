    ...
    @isset($header)
        <template v-slot:header="{ toggle, isOpen }">
            <div {{ $header->attributes->merge(['class' => 'flex items-center justify-between gap-2.5 border-b px-4 py-3 dark:border-gray-800']) }}>
                ...
                <span
                    class="icon-cancel-1 cursor-pointer text-3xl hover:rounded-md hover:bg-gray-100 dark:hover:bg-zinc-950"
                    @click="toggle"
                >
                </span>
            </div>
            ...
            >
                ...
                >
                    <div class="flex min-h-screen items-end justify-center p-4 sm:items-center sm:p-0">
                        <div class="box-shadow relative z-[999] w-screen max-w-[568px] rounded-lg bg-white dark:border-zinc-800 dark:bg-zinc-900 max-lg:mb-4 max-lg:mt-4 max-md:w-[90%]">
                            <!-- Header Slot -->
                            <slot
                                name="header"
                                :toggle="toggle"
