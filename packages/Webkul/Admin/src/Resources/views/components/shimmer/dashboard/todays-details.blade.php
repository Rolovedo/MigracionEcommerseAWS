<div class="box-shadow rounded">
    <div class="flex flex-wrap gap-4 border-b bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
    ...
    @for ($i = 1; $i <= 5; $i++)
        <div class="border-b bg-white p-4 transition-all hover:bg-gray-50 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:bg-zinc-950">
